const hybrids = [
    { id: 'afina', name: 'Афина', fao: '270-350', yield: 12, purpose: 'Зерно', height: '270', earLength: '18', rows: '14-18', grainsPerRow: '36', thousandSeedsMass: '335', img: 'https://placehold.co/400x300/1b4d3e/white?text=FENIKKS+Afina', desc: 'Ранний зерновой гибрид, компактный и надежный на засушливых полях.' },
    ...
    { id: 'aravia', name: 'Аравия', fao: 450, yield: 17, purpose: 'Зерно', height: '270', earLength: '19', rows: '18-20', grainsPerRow: '38', thousandSeedsMass: '365', img: 'https://placehold.co/400x300/1b4d3e/white?text=FENIKKS+Aravia', desc: 'Гибрид для среднепозднего периода, обеспечивает плотные початки и стабильный результат.' },
    ...
    { id: 'shanghai', name: 'Шанхай', fao: 700, yield: 21, purpose: 'Зерно', height: '360-410', earLength: '26', rows: '20-22', grainsPerRow: '50', thousandSeedsMass: '400', img: 'https://placehold.co/400x300/1b4d3e/white?text=FENIKKS+Shanghai', desc: 'Эталонный высокий зерновой гибрид с большим количеством зерен и мощной продуктивностью.' },
    ...
    { id: 'bora', name: 'Бора-Бора', fao: 600, yield: 20, purpose: 'Силос', height: '380', earLength: '24-28', rows: '18-20', grainsPerRow: '46', thousandSeedsMass: '370', img: 'https://placehold.co/400x300/1b4d3e/white?text=FENIKKS+Bora+Bora', desc: 'Силосный гибрид с высокой растительной массой и равномерным формированием початков.' },
...
const translations = {
    ru: {
        ...
        faqAnswer1: 'Мы доставляем семена по всему Казахстану в течение 3-5 рабочих дней после подтверждения оплаты.',
        ...
        footerText: '© 2026 ТОО/ИП БахАгро. Доставка по всему Казахстану.',
    ...
    kz: {
        ...
        faqAnswer1: 'Төлем расталғаннан кейін Қазақстан бойынша 3-5 жұмыс күнінде жеткіземіз.',
        faqQuestion2: 'Тұқымдар қалай жеткізіледі?',
        faqAnswer2: 'Тұқымдар фирмалық қаптарға оралған. 1 егістік бірлік — 80 000 дән.',
        footerText: '© 2026 ТОО/ШЖҚ БахАгро. Қазақстан бойынша жеткізу.',
